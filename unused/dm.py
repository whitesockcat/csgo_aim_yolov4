...
path = 'C:/Users/acer-/Downloads/TensorFlow-2.3.1-YOLOv4-CSGO-aimbot-master/dm7.19'
dms = ctypes.windll.LoadLibrary(path+'/RegDll.dll')
#ctypes.WinDLL
dms.SetDllPathW(path+'/dm.dll', 0)
